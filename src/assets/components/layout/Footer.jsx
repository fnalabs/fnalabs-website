        ...
        <div className='column is-narrow'>
          <nav className='level is-mobile'>
            <div className='level-item'>
              <AnalyticsLink to='https://github.com/fnalabs' target='_blank'>{svgGithub}</AnalyticsLink>
            </div>

            <div className='level-item'>
              <AnalyticsLink to='https://www.npmjs.com/org/fnalabs' target='_blank'>{svgNPM}</AnalyticsLink>
            </div>
          ...
          <Tile type='ancestor'>
            <Tile type='parent' vertical>
              <Tile type='child' centered>{svgFnALabs}</Tile>
