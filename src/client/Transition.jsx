    ...
    return (
      <Provider value={this.state}>
        ...
        {!this.state.isConsent &&
          ...
          >
            Hive<sup>io</sup> uses cookies to provide you the best experience. By clicking <strong>I Accept</strong> you are agreeing to our <Link to='/cookie'>Cookie</Link> and <Link to='/privacy'>Privacy</Link> Policies.
          </CookieConsent>
        }
      </Provider>
    )
