...
const Privacy: FC = () => (
  <>
    <title>FnA Labs - Privacy Policy</title>
    <meta name="description" content="Privacy policy for the FnA Labs company website." />

    <Section article>
      <Container content>
        <h1>Privacy Policy For FnA Labs</h1>
        <p>Effective Date: 09/08/2018<br />
          Applicable To <Link to='/'>https://fnalabs.com</Link>
        </p>
        ...
        <p>If you wish to modify any information We may have about You, or You wish to simply access any information We have about You, You may reach out to Us at the following email address: <a href='mailto:contact@fnalabs.com'>contact@fnalabs.com</a>.</p>
